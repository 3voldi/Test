...
module.exports = {
  ...
  async handleCommand({ message, event, args }) {
    const permission = ["61568791604271"]; // ton ID ici
    ...
    // Config GitHub
    const GITHUB_TOKEN = "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";//le token de ton GitHub 
    const REPO_OWNER = "3voldi";//ton Nom d'utilisateurs
    const REPO_NAME = "test";//le nom de ton repositoire
    const BRANCH = "main";
